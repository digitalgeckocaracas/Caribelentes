...
<form id="register-form" method="post" action="<?php echo admin_url( 'admin-ajax.php' ) ?>">
  ...
  <div class="form-group">
	...
	<input type="hidden" name="action" value="user_quick_register">
	<?php wp_nonce_field( 'user_quick_register' ) ?>
  <button type="submit" id="register-submit" class="btn btn-default" data-loading-text="<?php _e( 'Sending...', 'jp-basic' ) ?>"><?php _e( 'Register', 'jp-basic' ) ?></button>
</form>
